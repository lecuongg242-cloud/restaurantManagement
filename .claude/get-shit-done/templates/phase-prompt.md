...
<!-- For checkpoint task examples and patterns, see @E:/externalProjects/restaurant-system/.claude/get-shit-done/references/checkpoints.md -->
...
See `E:/externalProjects/restaurant-system/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `E:/externalProjects/restaurant-system/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
