...
```
Agent(
  prompt="Read E:/externalProjects/restaurant-system/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/VALIDATION.md`
