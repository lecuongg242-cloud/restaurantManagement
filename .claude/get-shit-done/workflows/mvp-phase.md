...
<required_reading>
@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/user-story-template.md
@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/spidr-splitting.md
@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
