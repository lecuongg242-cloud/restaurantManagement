...
<required_reading>
@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/ai-frameworks.md
@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/externalProjects/restaurant-system/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/externalProjects/restaurant-system/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/externalProjects/restaurant-system/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/externalProjects/restaurant-system/.claude/agents/gsd-eval-planner.md for instructions.
