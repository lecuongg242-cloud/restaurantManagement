...
See E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/discovery.md
...
Use E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/discovery.md.
