...
<template>
@E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@E:/externalProjects/restaurant-system/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `E:/externalProjects/restaurant-system/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @E:/externalProjects/restaurant-system/.claude/get-shit-done/workflows/diagnose-issues.md
