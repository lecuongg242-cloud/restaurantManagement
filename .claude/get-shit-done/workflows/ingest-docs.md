...
```bash
INIT=$(node "E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
