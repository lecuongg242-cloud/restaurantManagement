...
Key references:
- @E:/externalProjects/restaurant-system/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @E:/externalProjects/restaurant-system/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @E:/externalProjects/restaurant-system/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="E:/externalProjects/restaurant-system/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "E:/externalProjects/restaurant-system/.claude/get-shit-done/USER-PROFILE.md" "E:/externalProjects/restaurant-system/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at E:/externalProjects/restaurant-system/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `E:/externalProjects/restaurant-system/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @E:/externalProjects/restaurant-system/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to E:/externalProjects/restaurant-system/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to E:/externalProjects/restaurant-system/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at E:/externalProjects/restaurant-system/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at E:/externalProjects/restaurant-system/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to E:/externalProjects/restaurant-system/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="E:/externalProjects/restaurant-system/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    E:/externalProjects/restaurant-system/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   E:/externalProjects/restaurant-system/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        E:/externalProjects/restaurant-system/.claude/CLAUDE.md
```
