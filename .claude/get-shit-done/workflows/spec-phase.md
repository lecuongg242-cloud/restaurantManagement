...
```bash
INIT=$(node "E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/spec.md.
