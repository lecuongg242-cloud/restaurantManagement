...
```markdown
Read E:/externalProjects/restaurant-system/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/externalProjects/restaurant-system/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/externalProjects/restaurant-system/.claude/agents/gsd-ui-checker.md for instructions.
