...
INSTALL_JS_GLOBAL="E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
