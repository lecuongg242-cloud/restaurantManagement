...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `E:/externalProjects/restaurant-system/.claude/.gsd-surface.json`
(sibling to `E:/externalProjects/restaurant-system/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `E:/externalProjects/restaurant-system/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`E:/externalProjects/restaurant-system/.claude/skills`).
...
`E:/externalProjects/restaurant-system/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `E:/externalProjects/restaurant-system/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `E:/externalProjects/restaurant-system/.claude/.gsd-surface.json`
Install profile marker: `E:/externalProjects/restaurant-system/.claude/.gsd-profile`
Skill dirs: `E:/externalProjects/restaurant-system/.claude/skills/gsd-*/`
Engine module: `E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `E:/externalProjects/restaurant-system/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
